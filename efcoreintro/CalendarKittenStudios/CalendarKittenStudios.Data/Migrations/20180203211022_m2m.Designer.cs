...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CalendarKittenStudios.Domain.ModelingEngagement", b =>
                {
                    b.Property<int>("KittenID");

                    b.Property<int>("CalendarPageID");

                    b.HasKey("KittenID", "CalendarPageID");

                    b.HasIndex("CalendarPageID");

                    b.ToTable("ModelingEngagement");
                });
            ...
            modelBuilder.Entity("CalendarKittenStudios.Domain.ModelingEngagement", b =>
                {
                    b.HasOne("CalendarKittenStudios.Domain.CalendarPage", "CalendarPage")
                        .WithMany("Bookings")
                        .HasForeignKey("CalendarPageID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CalendarKittenStudios.Domain.Kitten", "Kitten")
                        .WithMany()
